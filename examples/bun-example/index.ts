...
<html>
<head>
    <title>Bun Hello World - Miget</title>
    <style>
...
<body>
    <div class="container">
        ...
        <h1>Hello, ${Bun.escapeHTML(name)}!</h1>
        <p class="greeting">Welcome to Bun application built by Migetpacks</p>
        <div class="info-card">
            <div class="info-row">
                <span class="info-label">Runtime</span>
                <span class="info-value">Bun</span>
            </div>
            <div class="info-row">
                <span class="info-label">Version</span>
                <span class="info-value">${Bun.version}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Revision</span>
                <span class="info-value">${Bun.revision.slice(0, 8)}</span>
            </div>
        </div>
