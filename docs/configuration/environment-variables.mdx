...
| `BUILD_ATTESTATIONS` | No | `false` | Attach BuildKit provenance and SBOM attestations to the pushed image. Off by default because attestation manifests are not deletable in some registries |
