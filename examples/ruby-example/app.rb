...
<html>
<head>
    <title>Ruby Hello World - Miget</title>
    <style>
...
<body>
    <div class="container">
        ...
        <h1>Hello, <%= name %>!</h1>
        <p class="greeting">Welcome to Ruby application built by Migetpacks</p>
        <div class="info-card">
            <div class="info-row">
                <span class="info-label">Runtime</span>
                <span class="info-value">Ruby</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><%= RUBY_PLATFORM %></span>
            </div>
        </div>
...
get '/' do
  name = ERB::Util.html_escape(params[:name] || 'World')
  erb HTML_TEMPLATE, locals: { name: name }
end
